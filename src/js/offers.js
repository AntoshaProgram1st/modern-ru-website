        ...
        if (mfoList.length > 0) {
            ...
            priorityContainer.innerHTML = `
                <div class="priority-offer-card">
                    <div class="priority-offer-logo"><img src="../assets/images/mfo-logos/${top.logo}" alt="${top.name}"></div>
        ...
        mfoList.slice(1, 20).forEach(mfo => {
            ...
            offersList.innerHTML += `
                <div class="offer-simple-card">
                    <div class="offer-simple-logo"><img src="../assets/images/mfo-logos/${mfo.logo}" alt="${mfo.name}"></div>
